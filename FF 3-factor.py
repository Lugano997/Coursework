...
# Make the datasets consistent with our sample period --> 196307 to 201912
...
# Filter sample from 196307-201912
FF3 = FF3[(FF3['year'] <= 2019) & (FF3['year'] >= 1963)]
...
# Filter sample from 196307-201912
ff_factors = ff_factors[(ff_factors['year'] <= 2019) & (ff_factors['year'] >= 1963)]
